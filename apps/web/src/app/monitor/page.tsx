...
const MOCK_ENVIRONMENTS = {
  dev: {
    ...
    services_count: 4,
    alerts_count: 1,
    endpoint_url: "https://dev-api.ecommerce-a3f2k.jetrun.app",
  ...
  staging: {
    ...
    services_count: 3,
    alerts_count: 2,
    endpoint_url: "https://staging-api.ecommerce-a3f2k.jetrun.app",
...
const MOCK_DRIFT_EVENTS = [
  {
    ...
    detail: "Memory configuration changed externally: 512MB → 1024MB. This was modified directly in the AWS console, bypassing JetRun.",
  ...
  },
  {
    ...
    detail: "ElastiCache cluster 'ecommerce-staging-cache' found in AWS but not tracked by JetRun. This may be a manually created resource or leftover from a failed deployment.",
  ...
  },
  {
    ...
    resource_type: "S3",
    drift_type: "config_change" as const,
    detail: "Bucket versioning was disabled externally. JetRun expects versioning=enabled per architecture spec.",
